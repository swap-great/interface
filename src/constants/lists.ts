...
export const BASE_SEPOLIA_LIST =
  'https://raw.githubusercontent.com/0xdefi-club/swap-default-token-list/main/src/tokens/base_sepolia.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [BASE_SEPOLIA_LIST]
